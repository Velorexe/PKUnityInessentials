...
new PokemonData(6, "Charizard", PokemonData.Type.FIRE, PokemonData.Type.FLYING, "Blaze", null, "Solar-power",
	...
	new string[]
	{
		 "Mega_Punch", "Swords_Dance", "Cut", "Fly", "Mega_Kick", "Body_Slam", "Take_Down", "Double_Edge", "Hyper_Beam", "Submission", "Counter", "Seismic_Toss", "Strength", "Dragon_Rage", "Earthquake", "Fissure", "Dig", "Toxic", "Rage", "Mimic", "Double_Team", "Reflect", "Bide", "Fire_Blast", "Swift", "Skull_Bash", "Rest", "Substitute"
	},
	new int[] {}, new string[] {}),
...
new PokemonData(12, "Butterfree", PokemonData.Type.BUG, PokemonData.Type.FLYING, "Compound-eyes", null, "Tinted-lens",
	...
	new string[]
	{
		 "Razor_Wind", "Whirlwind", "Take_Down", "Double_Edge", "Hyper_Beam", "Mega_Drain", "Solar_Beam", "Toxic", "Psychic", "Rage", "Teleport", "Mimic", "Double_Team", "Reflect", "Bide", "Swift", "Flash", "Psywave", "Rest", "Substitute"
	},
	new int[] {}, new string[] {}),
...
new PokemonData(33, "Nidorino", PokemonData.Type.POISON, PokemonData.Type.NONE, "Poison-point", "Rivalry", "Hustle",
	...
	new int[] { 1, 1, 1, 12, 19, 27, 46},
	new string[]
	{
		 "Horn Attack", "Tackle", "Leer", "Double Kick", "Poison Sting", "Focus Energy", "Horn Drill",
	},
	new string[]
	{
		 "Horn_Drill", "Body_Slam", "Take_Down", "Double_Edge", "Water_Gun", "Ice_Beam", "Blizzard", "Bubble_Beam", "Thunderbolt", "Thunder", "Toxic", "Rage", "Mimic", "Double_Team", "Reflect", "Bide", "Skull_Bash", "Rest", "Substitute"
...
new PokemonData(34, "Nidoking", PokemonData.Type.POISON, PokemonData.Type.GROUND, "Poison-point", "Rivalry", "Sheer-force",
	...
	new string[]
	{
		 "Horn Attack", "Thrash", "Double Kick",
	},
	new string[]
	{
		 "Mega_Punch", "Pay_Day", "Mega_Kick", "Horn_Drill", "Body_Slam", "Take_Down", "Double_Edge", "Water_Gun", "Surf", "Ice_Beam", "Blizzard", "Bubble_Beam", "Hyper_Beam", "Submission", "Counter", "Seismic_Toss", "Strength", "Thunderbolt", "Thunder", "Earthquake", "Fissure", "Toxic", "Rage", "Mimic", "Double_Team", "Reflect", "Bide", "Fire_Blast", "Skull_Bash", "Rest", "Rock_Slide", "Substitute"
...
new PokemonData(48, "Venonat", PokemonData.Type.BUG, PokemonData.Type.POISON, "Compound-eyes", "Tinted-lens", "Run-away",
	...
	new int[] { 1, 1, 11, 19, 22, 27, 30, 35, 38, 43},
	new string[]
	{
		 "Tackle", "Disable", "Supersonic", "Confusion", "Poison Powder", "Leech Life", "Stun Spore", "Psybeam", "Sleep Powder", "Psychic",
	},
	new string[]
	{
		 "Take_Down", "Double_Edge", "Mega_Drain", "Solar_Beam", "Toxic", "Psychic", "Rage", "Mimic", "Double_Team", "Reflect", "Bide", "Flash", "Psywave", "Rest", "Substitute"
	},
...
new PokemonData(49, "Venomoth", PokemonData.Type.BUG, PokemonData.Type.POISON, "Shield-dust", "Tinted-lens", "Wonder-skin",
	...
	new int[] { 1, 1, 1, 1, 22, 27, 30, 38, 43, 50},
	new string[]
	{
		 "Tackle", "Supersonic", "Disable", "Confusion", "Poison Powder", "Leech Life", "Stun Spore", "Psybeam", "Sleep Powder", "Psychic",
	},
	new string[]
	{
		 "Razor_Wind", "Whirlwind", "Take_Down", "Double_Edge", "Hyper_Beam", "Mega_Drain", "Solar_Beam", "Toxic", "Psychic", "Rage", "Teleport", "Mimic", "Double_Team", "Reflect", "Bide", "Swift", "Flash", "Psywave", "Rest", "Substitute"
...
new PokemonData(50, "Diglett", PokemonData.Type.GROUND, PokemonData.Type.NONE, "Sand-veil", "Arena-trap", "Sand-force",
	...
	new string[]
	{
		 "Cut", "Body_Slam", "Take_Down", "Double_Edge", "Earthquake", "Fissure", "Dig", "Toxic", "Rage", "Mimic", "Double_Team", "Bide", "Rest", "Rock_Slide", "Substitute"
	},
...
new PokemonData(51, "Dugtrio", PokemonData.Type.GROUND, PokemonData.Type.NONE, "Sand-veil", "Arena-trap", "Sand-force",
	...
	new string[]
	{
		 "Cut", "Body_Slam", "Take_Down", "Double_Edge", "Hyper_Beam", "Earthquake", "Fissure", "Dig", "Toxic", "Rage", "Mimic", "Double_Team", "Bide", "Rest", "Rock_Slide", "Substitute"
	},
	new int[] {}, new string[] {}),
...
new PokemonData(56, "Mankey", PokemonData.Type.FIGHTING, PokemonData.Type.NONE, "Vital-spirit", "Anger-point", "Defiant",
	...
	new int[] { 1, 1, 9, 15, 21, 27, 33, 39, 45},
	new string[]
	{
		 "Scratch", "Leer", "Low Kick", "Karate Chop", "Fury Swipes", "Focus Energy", "Seismic Toss", "Thrash", "Screech",
	},
	new string[]
	{
...
new PokemonData(57, "Primeape", PokemonData.Type.FIGHTING, PokemonData.Type.NONE, "Vital-spirit", "Anger-point", "Defiant",
	...
	new int[] { 1, 1, 1, 21, 27, 28, 45, 46},
	new string[]
	{
		 "Karate Chop", "Leer", "Low Kick", "Fury Swipes", "Focus Energy", "Rage", "Screech", "Thrash",
	},
	new string[]
	{
...
new PokemonData(64, "Kadabra", PokemonData.Type.PSYCHIC, PokemonData.Type.NONE, "Synchronize", "Inner-focus", "Magic-guard",
	...
	new int[] { 1, 1, 16, 20, 27, 31, 38, 42},
	new string[]
	{
		 "Teleport", "Kinesis", "Confusion", "Disable", "Psybeam", "Recover", "Psychic", "Reflect",
	},
	new string[]
	{
...
new PokemonData(104, "Cubone", PokemonData.Type.GROUND, PokemonData.Type.NONE, "Rock-head", "Lightning-rod", "Battle-armor",
	...
	new int[] { 1, 10, 13, 18, 25, 31, 38, 43, 46},
	new string[]
	{
		 "Growl", "Bone Club", "Tail Whip", "Headbutt", "Leer", "Focus Energy", "Thrash", "Bonemerang", "Rage",
	},
	new string[]
	{
...
new PokemonData(105, "Marowak", PokemonData.Type.GROUND, PokemonData.Type.NONE, "Rock-head", "Lightning-rod", "Battle-armor",
	...
	new int[] { 1, 1, 18, 33, 41, 55},
	new string[]
	{
		 "Tail Whip", "Bone Club", "Headbutt", "Focus Energy", "Thrash", "Rage",
	},
	new string[]
	{
...
new PokemonData(113, "Chansey", PokemonData.Type.NORMAL, PokemonData.Type.NONE, "Natural-cure", "Serene-grace", "Healer",
	...
	new int[] { 1, 1, 12, 24, 30, 38, 44, 48, 54},
	new string[]
	{
		 "Pound", "Tail Whip", "Double Slap", "Sing", "Growl", "Minimize", "Defense Curl", "Light Screen", "Double-Edge",
	},
	new string[]
	{
...
new PokemonData(114, "Tangela", PokemonData.Type.GRASS, PokemonData.Type.NONE, "Chlorophyll", "Leaf-guard", "Regenerator",
	...
	new int[] { 1, 24, 27, 29, 32, 36, 39, 45, 48},
	new string[]
	{
		 "Constrict", "Bind", "Absorb", "Vine Whip", "Poison Powder", "Stun Spore", "Sleep Powder", "Slam", "Growth",
	},
	new string[]
	{
...
new PokemonData(123, "Scyther", PokemonData.Type.BUG, PokemonData.Type.FLYING, "Swarm", "Technician", "Steadfast",
	...
	new int[] { 1, 17, 20, 24, 29, 35, 42, 50},
	new string[]
	{
		 "Quick Attack", "Leer", "Focus Energy", "Double Team", "Slash", "Swords Dance", "Agility", "Wing Attack",
	},
	new string[]
	{
...
new PokemonData(127, "Pinsir", PokemonData.Type.BUG, PokemonData.Type.NONE, "Hyper-cutter", "Mold-breaker", "Moxie",
	...
	new int[] { 1, 21, 25, 30, 36, 43, 49, 54},
	new string[]
	{
		 "Vice Grip", "Bind", "Seismic Toss", "Guillotine", "Focus Energy", "Harden", "Slash", "Swords Dance",
	},
	new string[]
	{
...
new PokemonData(130, "Gyarados", PokemonData.Type.WATER, PokemonData.Type.FLYING, "Intimidate", null, "Moxie",
	...
	new int[] { 1, 20, 25, 32, 41, 52},
	new string[]
	{
		 "Tackle", "Bite", "Dragon Rage", "Leer", "Hydro Pump", "Hyper Beam",
	},
	new string[]
	{
...
new PokemonData(134, "Vaporeon", PokemonData.Type.WATER, PokemonData.Type.NONE, "Water-absorb", null, "Hydration",
	...
	new int[] { 1, 1, 1, 1, 8, 30, 36, 42, 47},
	new string[]
	{
		 "Tackle", "Tail Whip", "Water Gun", "Quick Attack", "Sand Attack", "Bite", "Aurora Beam", "Mist", "Acid Armor",
	},
	new string[]
	{
...
new PokemonData(135, "Jolteon", PokemonData.Type.ELECTRIC, PokemonData.Type.NONE, "Volt-absorb", null, "Quick-feet",
	...
	new int[] { 1, 1, 1, 1, 8, 30, 36, 47, 52},
	new string[]
	{
		 "Tackle", "Tail Whip", "Thunder Shock", "Quick Attack", "Sand Attack", "Double Kick", "Pin Missile", "Agility", "Thunder",
	},
	new string[]
	{
...
new PokemonData(136, "Flareon", PokemonData.Type.FIRE, PokemonData.Type.NONE, "Flash-fire", null, "Guts",
	...
	new int[] { 1, 1, 1, 1, 8, 30, 36, 47},
	new string[]
	{
		 "Tackle", "Tail Whip", "Ember", "Quick Attack", "Sand Attack", "Bite", "Fire Spin", "Leer",
	},
	new string[]
	{
...
new PokemonData(141, "Kabutops", PokemonData.Type.ROCK, PokemonData.Type.WATER, "Swift-swim", "Battle-armor", "Weak-armor",
	...
	new string[]
	{
		 "Razor_Wind", "Swords_Dance", "Cut", "Mega_Kick", "Body_Slam", "Take_Down", "Double_Edge", "Water_Gun", "Surf", "Ice_Beam", "Blizzard", "Bubble_Beam", "Hyper_Beam", "Submission", "Seismic_Toss", "Toxic", "Rage", "Mimic", "Double_Team", "Reflect", "Bide", "Skull_Bash", "Rest", "Substitute"
	},
	new int[] {}, new string[] {}),
